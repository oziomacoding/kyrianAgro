...
function Card() {
    const cardData=[
        ...
        {image:pics2,title:'Cash Crop Farming', content:'In addition to our poultry operations, we cultivate a wide range of cash crops. Our farm produces grains, vegetables, and fruits that are grown using sustainable farming practices. We focus on crops such as wheat, corn, tomatoes, cashew nuts, cassava, palmnuts and other cash crops which are carefully nurtured to deliver the best possible yield and quality.'},
    ]
  return (
    <>
      <div className="row">
        {cardData.map((Card,index) =>(
            <div className="col-md-6 mb-5 d-flex" data-aos="fade-up">
