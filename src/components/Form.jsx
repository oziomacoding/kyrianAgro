...
<form action="" onSubmit={handleSubmit}>
          ...
          <textarea name="message" id="" cols="30" rows="10" className={`form-control mt-3 ${errors.message && 'is-invalid'}`} onChange={handleChange} value={formData.message} placeholder='Enter your message here'></textarea>
